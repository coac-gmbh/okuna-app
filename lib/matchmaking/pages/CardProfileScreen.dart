...
class CardProfileScreen extends StatefulWidget {
  final User user;
  const CardProfileScreen({ Key key, this.user }) : super(key: key);
    ...
    return Container(
      child: Center(
        child: ClipRRect(
          ...
          navigationBar: OBThemedNavigationBar(title: '@' + _user.username),
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Container( height: 65,child: OBProfileBio(_user)),
